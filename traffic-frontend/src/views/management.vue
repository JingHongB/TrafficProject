      ...
      <el-main>
        ...
        <div v-if="activeModule === 'task'">
          ...
          <el-table :data="taskList" style="width: 100%">
            ...
            <el-table-column prop="goods" label="货物类型" width="120"/>
        ...
        <div v-if="activeModule === 'goods'">
          <el-table :data="goodsList" style="width: 100%">
            ...
            <el-table-column prop="owner" label="货主" width="120"/>
        ...
        <div v-if="activeModule === 'car'">
          <el-table :data="carList" style="width: 100%">
            ...
            <el-table-column prop="loadCapacity" label="载重(kg)" width="120"/>
      ...
      <el-form :model="formData" label-width="120px">
        <template v-if="activeModule === 'task'">
          ...
          <el-form-item label="起点">
            <el-input v-model="formData.start_id"/>
          </el-form-item>
          <el-form-item label="终点">
            <el-input v-model="formData.end_id"/>
          </el-form-item>
        ...
        <template v-if="activeModule === 'goods'">
          <el-form-item label="类型">
            <el-input v-model="formData.type_id"/>
          </el-form-item>
          ...
          <el-form-item label="货主">
            <el-input v-model="formData.owner_id"/>
          </el-form-item>
        </template>
        ...
        <template v-if="activeModule === 'car'">
          ...
          <el-form-item label="车辆类型">
            <el-select v-model="formData.typeId" placeholder="请选择车辆类型">
          ...
          <el-form-item label="载重(t)">
            <el-input-number v-model="formData.loadCapacity" :disabled="true"/>
          </el-form-item>
          <el-form-item label="经度">
            <el-input-number v-model="formData.longitude" placeholder="请输入经度"/>
          </el-form-item>
          <el-form-item label="纬度">
            <el-input-number v-model="formData.latitude" placeholder="请输入纬度"/>
          </el-form-item>
        </template>
        ...
        <template v-if="activeModule === 'poi'">
          ...
          <el-form-item label="经度">
            <el-input-number v-model="formData.longitude"/>
          </el-form-item>
          <el-form-item label="纬度">
            <el-input-number v-model="formData.latitude"/>
          </el-form-item>
          <el-form-item label="状态">
            <el-input v-model="formData.status"/>
          </el-form-item>
